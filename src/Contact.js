 ...
 <section class="text-gray-600 body-font relative">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 -mt-16">Contact Us</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Contact us in case of any queries or feedbacks<br /> Crime Reducer community is always there to help you</p>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2 -mt-10">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-red-500">nishathsbuisness@gmail.com</a>
          <p class="leading-normal my-5">Madathukulam
            <br />Madathukulam, Tiruppur-642113
          </p>
